<template>
  <form class="p-10" @submit.prevent="onSubmit" @keydown="form.errors.clear()">
    <header class="section py-4 mb-4" style="background: url('/images/splash.svg') 108px 4px no-repeat;">
      <h1 class="text-black text-center text-2xl mb-2">Register New User</h1>
    </header>
