<template>
  ...
  <form class="m-2 p-2" @submit.prevent="onSubmit" @keydown="form.errors.clear()">
    ...
    <div class="flex">
      <div class="ml-auto control flex">
          <button @click.prevent="$modal.hide('addNotesModal')" class="btn mr-2 text-grey-darker text-lg hover:border-blue hover:text-blue rounded-full py-1 px-4 border-1 border-grey">Cancel</button>
          <button 
            type="submit" 
