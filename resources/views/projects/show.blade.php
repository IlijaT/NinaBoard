...
<div class="lg:flex -mx-3 items-start mb-3 -mt-2">
        ...
        <header class="flex items-center px-2">
            <div class="flex justify-between items-end w-full">
                <p class="text-lg text-grey text-sm font-normal">
                    <a href="/projects" 
                    class="text-lg text-grey-dark text-sm font-normal"
            ...
            <div class="lg:w-3/5 mb-6 mx-2">
                ...
                <div>
                    ...
                    <form class="text-right"  action="{{ $project->path() }}" method="POST">
                        ...
                        <button type="submit" class="py-1 px-3 text-lg button rounded-full text-white is-link hover:bg-blue-dark border-2 border-blue">Add Note</button>
                    </form>
                </div>
    ...
    <div class="lg:flex -mx-3"> --}}
        ...
        {{-- left side - add task and task email show --}}
